...
\bigskip
  \item[¿Por qué?] Respuesta: Aprenda con nosotros sobre arquitecturas :) \\ \textbf{POR FAVOOOOORRRRR!!!!! DIGAN LA RESPUESTAAAAAA!!!} 
...
\bigskip
  \item[¿Por qué?] Respuesta: Aprenda con nosotros sobre arquitecturas :) \\ \textbf{Bien, Ahí va:} 
\bigskip 
\textbf{El programa mem2.c utiliza menos RAM. Esto se debe a que la arquitectura impone que las palabras deben estar alineadas en memoria} 

\bigskip 
\texttt{Aprender sobre Arquitecturas y Organización aporta conocimiento que ayudan a ser mejores programadores.}
	\end{small}
	\end{itemize}
