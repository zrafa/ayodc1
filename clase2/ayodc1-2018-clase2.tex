...
\begin{itemize}
	\item Repaso de la historia del concepto Arquitectura y Organización
...
\textbf{Programación de la máquina}
\begin{itemize}
	\item \textbf{Repaso de la historia del concepto Arquitectura y Organización}
	\item El lenguaje de la máquina
	\item Evolucion: CISC, RISC, multiprocesadores
\end{itemize}
\end{frame}
...
\includegraphics[scale=0.2]{x86-ejemplo.jpg} 
	\end{center}
...
\includegraphics[scale=0.2]{real-arquitecturas.jpg} 
	\end{center}
\end{frame}
