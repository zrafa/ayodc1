...
\begin{itemize}
	\item  Arquitectura: (tambien ISA: instruction set architecture) Las componentes del diseño del procesador 
...
\item  MicroarquitecturaMicroarchitecture: Implementation of the architecture.
 Examples: cache sizes and core frequency.
\item Example ISAs (Intel): x86, IA
