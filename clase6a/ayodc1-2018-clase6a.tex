...
\institute{Rafael Ignacio Zurita \\ Departamento de Ingenieria de Computadoras \\ Clase presencial 6a}
%\date{\today}
...
Características de las diferentes tecnologías de memoria. \textbf{Comportamiento de los programas: principio de localidad. Jerarqu\'ia de memoria}. Memoria Cache. Memoria virtual.  
...
\item Memorias
\item Estrategias de organización posibles
\item Principio de localidad
\item Jerarquía de memoria
\item DRAM vs SRAM
\item Repaso y cierre
\end{itemize}
...
\frametitle{Jerarqu\'ia de Memoria}
 ...
 \textbf{¿Por qué necesitamos tantos tipos de memoria?}
\begin{itemize}
\item \textbf{RESPUESTA: Porque no es posible construir la memoria ideal con la tecnología actual} 
\item Memoria ideal: ilimitada (siempre suficiente), veloz (tiempo de respuesta, ancho de banda), densa (tamaño físico), de bajo consumo, robusta, barata, persistente. Pero, la tecnología es insuficiente
\end{itemize}
...
\frametitle{Jerarqu\'ia de Memoria}
        \begin{center}
        \textbf{Verifique su comprensión del tema}
        \end{center}
\begin{enumerate}
\item ¿Qué significa el principio de localidad?.
\item Intente componer y redactar una analogía no técnica.
\item Evaluar el tiempo de ejecución de los dos programas a continuacion.
\item Debatir en grupo por qué es posible que existe una diferencia.
\item En base a la respuesta anterior: ¿Considera que es importante el estudio de Jerarquía de Memoria?.
\end{enumerate}
\end{frame}
...
\begin{center}
\begin{figure}
\includegraphics[scale=0.35]{jer-test.jpg} 
\end{figure}
\end{center}
\end{frame}
...
\begin{itemize}
\item  ¿Preguntas?
\item  Próximas clases: Caché y Memoria Virtual
\end{itemize}
\end{center}
\end{frame}
