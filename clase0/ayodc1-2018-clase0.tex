...
\institute{Rafael Ignacio Zurita \\ Departamento de Ingenieria de Computadoras - FAI - UNCOMA \\ 2018}
%\date{\today}
...
Es necesario aprobar cada parcial en primera instancia para acceder a los exámenes para la promoción.
 \\~\\
Los exámenes parciales incluyen unicamente una parte parte práctica.
Los exámenes para la promoción incluyen unicamente temas teóricos.
\end{frame}
